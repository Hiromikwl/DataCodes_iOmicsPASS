...
combup = data.frame(ALLPup,pval_basalup,pval_her2up,pval_lumAup,pval_lumBup)
combup$Annot = pathAnnot$Function[match(ALLPup,pathAnnot$Pathwayid)]
combup = combup[,c(1,6,2:5)]

combdown = data.frame(ALLPdown,pval_basaldown,pval_lumAdown,pval_lumBdown)
combdown$Annot = pathAnnot$Function[match(ALLPdown,pathAnnot$Pathwayid)]
