...
plot(PC1,PC2,cex =0.7,type="n",ylim=c(-70,70),xlim=c(-100,100),xlab=paste0("PC1 (", expl.var[1], "%)"),ylab=paste0("PC2 (", expl.var[2], "%)"),cex.lab = 0.8)
points(PC1,PC2,pch=pchCol,col=colvec)
abline(h=0,lty=2)
abline(v=0,lty=2)
legend(-100,90, uniqS, xpd = TRUE, horiz = TRUE, inset = c(0, 0),
